app.controller('Paso1Controller', ['$scope', '$location', function ($scope, $location) {
    var names = [
    ...
    var typesDoc = [
        { 'id': 0, 'description': 'DNI' },
        { 'id': 1, 'description': 'LC' },
        { 'id': 2, 'description': 'LE' },
        { 'id': 3, 'description': 'CI' },
        { 'id': 4, 'description': 'PASAPORTE' },
        { 'id': 5, 'description': 'RENAPER' }
    ];
    ...
    $scope.data = {
        names: names,
        nameSelected: names[0], // or null
        typesDoc: typesDoc,
        typeDocSelected: typesDoc[0],
        nationalities: nationality,
        nationalitySelected: nationality[10] //Argentina
    };

    $scope.continue = function () {
        $location.path('/referidos/paso2');
    }
